  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-content">
        <span className="section-eyebrow">Karma KIA</span>
        <h1>{title}</h1>
        <p className="legal-updated">Last updated: 23 August 2026</p>
        <p className="legal-intro">This {isPrivacy ? 'policy explains how information is handled when you use the Karma KIA website or contact our dealership team' : 'page sets out the terms that apply when you use the Karma KIA website'}.</p>
